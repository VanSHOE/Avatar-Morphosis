...
const UIColor = () => {
    ...
    function send4lipsync() {
        ...
        axios
            .post('http://https://mernvendorbuyer.me:4000/upload/modelize', data, {
    ...
    useEffect(() => {
        axios
            .get('http://https://mernvendorbuyer.me:4000/upload/get_files', { headers: { 'x-access-token': localStorage.getItem('user') } })
            .then((res) => {
                setFiles(res.data);
                                            ...
                                            >
                                                <div>
                                                    <img
                                                        ...
                                                        alt="Custom"
                                                        src={'http://https://mernvendorbuyer.me:4000/' + file.path}
                                                    />
                                                </div>
                                            </div>
                                        </Button>
                ...
                <Grid item xs={1} alignContent="center" justifyContent="center">
                    ...
                    <Dialog open={open} onClose={handleToClose}>
                        ...
                        <DialogContent>
                            ...
                            <img src={'http://https://mernvendorbuyer.me:4000/' + selectedImage.path} alt="Custom" height="250px" />
                            <DialogContentText>Audio Selected</DialogContentText>
                            <audio controls>
                                <source src={'http://https://mernvendorbuyer.me:4000/' + selectedAudio.path} type="audio/mpeg" />
                                <track kind="captions" />
                            </audio>
                        </DialogContent>
                        <DialogActions>
